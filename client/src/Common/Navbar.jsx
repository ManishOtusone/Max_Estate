...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 left-0 right-0 bg-[#fafaf8] z-50 shadow-sm">
                <div className="mx-auto w-full max-w-[1280px] flex items-center justify-between py-3 px-4">
                    ...
                    <div className="flex-shrink-0">
                        <img
                            src={Maxlogo}
                            alt="Max Logo"
                            className="w-[75px] h-[38px] md:w-[130px] md:h-[62.25px]"
                        />
                    </div>
                    ...
                    <ul className="hidden md:flex md:space-x-6 text-black font-medium">
                        {links.map((link) => (
                            <li
                                ...
                                className={`cursor-pointer border-b-2 md:border-b-0 transition-all duration-300 py-2 md:py-0 px-4 md:px-0 ${active === link.name
                                    ? "border-[#67132f] text-[#67132f]"
                                    : "border-transparent"
                    ...
                    <div className="flex items-center space-x-1 md:space-x-4">
                        <img
                            src={AntaraLogo}
                            alt="Antara Logo"
                            className="h-[24px] w-auto md:h-[58.89px] md:w-[210px]"
                        />
                ...
                >
                    {links.map((link) => (
                        <li
                            key={link.name}
                            onClick={() => handleClick(link)}
                            className={`cursor-pointer border-b-2 transition-all duration-300 py-2 px-4 ${active === link.name
                                ? "border-[#67132f] text-[#67132f]"
                                : "border-transparent"
                                } hover:border-[#67132f] hover:text-[#67132f]`}
                        >
